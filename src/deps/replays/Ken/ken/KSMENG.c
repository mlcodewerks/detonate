...
int32_t ksmsamplerate, ksmnumspeakers = 2, ksmbytespersample = 2;
...
unsigned char instsdat[256][11] =		// EMSCRIPTEN (was "char")
{
...
uint32_t note[8192], musicstatus, count, countstop, loopcnt;
unsigned int nownote, numnotes = 0, numchans, firstime = 1;
int32_t speed = 240;
unsigned int drumstat;
uint32_t chanage[18];
unsigned char inst[256][11], chanfreq[18], chantrack[18];
unsigned char trinst[16], trquant[16], trchan[16], trprio[16];
unsigned char trvol[16], adlibchanoffs[9] = {0,1,2,8,9,10,16,17,18};
unsigned int adlibfreq[63] =
{
	0,
...
void ksmnexttic ()
{
	int32_t i, j, k, track, volevel, templong;
...
int32_t minicnt = 0;
int32_t ksmrendersound (void *dasnd, int32_t numbytestoprocess)
{
	int32_t i, prepcnt;
